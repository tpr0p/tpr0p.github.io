...
\begin{itemize}
  ...
  \item Assess and implement numerical techniques to achieve efficient and accurate quantum
        system simulation
\end{itemize}
...
\begin{tabular}{@{} L{14cm} @{} R{2.51cm} @{}}
  ...
  Enrico Fermi Scholar, GPA in top 5\% from past 5 years, UChicago PSD & 2020\\
